...
function mostrarContenidoCurso() {
  ...
  const contenidoCurso = `
    <p>Bienvenido al curso Cultura General. A continuación, encontrarás contenido multimedia:</p>
    <ul>
      <li><a href="https://es.wikipedia.org/wiki/Cultura_general" target="_blank">¿Cultura General?</a></li>
      <li><img src="culturageneral.png" alt="Imagen de ejemplo" width="480" height="380"></li>
      <li><iframe width="560" height="315" src="https://www.youtube.com/embed/fLYwV-WBbMk"" frameborder="0" allowfullscreen></iframe></li>
    </ul>
...
function realizarEvaluacion() {
  ...
  const preguntasEvaluacion = `
    <h2>Evaluación</h2>
<div class="pregunta">
    <label>Pregunta 1: ¿De qué colores es la bandera de México?</label>
<div>    
    <input type="checkbox" id="pregunta1_opcion1"> Verde, blanco y rojo
</div>
<div>
...
<br> 
<div class="pregunta">
    <label>Pregunta 2: ¿En qué continente está Ecuador?</label>
<div>
...
<br> 
<div class="pregunta">
    <label>Pregunta 5: ¿Cuál es el metal más caro del mundo?</label>
<div>
    <input type="radio" name="pregunta5" id="pregunta5_opcion1"> Oro
</div>
<div>
...
<div>
    <input type="radio" name="pregunta6" id="pregunta6_opcion2"> Mister Rock
</div>
</div>
<br> 
<div class="pregunta">
...
<div>
    <input type="radio" name="pregunta7" id="pregunta7_opcion1"> Olfato
</div>
<div>
...
<br>
<div class="pregunta">
    <label>Pregunta 9: ¿Quién es el dios del fuego en la mitodología romana?</label>
<div>
    <input type="radio" name="pregunta9" id="pregunta9_opcion1"> Vulcano
</div>
<div>
